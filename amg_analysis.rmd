...
dim(df_12)
```
```{r "Colnames of the Data Frame"}
# names of the column
colnames(df_08)
colnames(df_12)
```
```{r "Additional Details of the Data Frame"}
# Detail description of data frames
str(df_08)
str(df_12)
```
```{r "Selected Features/Colnames for analysis and ordering "}
...
```
```{r "Selected Features/Colnames for analysis and ordering them"}
...
```
```{r "Standardizing the party registration variable"}
...
```
```{r "Creating the Party Preference Variable from questions q06, q06a, q06b"}
...
```{r "Creating and standardizing the party registration variable for the year 2012"}
...
```
```{r "Creating a Party Preference Variable from three quesions q8, q8a, q8b"}
...
```
```{r "Standardizing the ethnicity for the two years 2008 and 2012"}
...
table(df_12$d8com)
```
```{r"Creating a year variable for the two dataframes, to distinguish respective year entries"}
...
```
```{r "Writing the final file in csv to disk"}
...
colnames(df)
```
```{r "Plotting presendial preference in year 2008 vs 2012"}
...
```{r "Graphs for the factors/questions ~ year"}
# Graphs showing important patterns and shifts in perceptions
q01  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( q01~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
q02  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( q02~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
q03  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( q03~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
q24  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( q24~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
q36  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( q36~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
q38  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( q38~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
q39  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( q39~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
q45  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( q45~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
q46a  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( q46a~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
q46b  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( q46b~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
```
```{r "Weights for the  questions to presidential ticket preference"}
##weights of 2008
...
q46b
```
```{r "Relevant but not that important factors"}
# Relevant Graphs with some importance
q07  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( q07~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
q16  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( q16~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
q37  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( q37~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
q40  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( q40~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
q46  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( q46~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
gen_year  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( gender~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
lan_year  <- ggplot(data = df, aes(x = pres_ticketpref)) + geom_histogram() + facet_grid( language~year,scales = "free") + scale_fill_discrete() + xlab("Presidential Ticket Preference") + ylab("No of Voters")
```
```{r "Plotting them for the HTML"}
q07
q16
q37
q40
...
```{r "Graphs showing important demographic Relationships"}
...
```
#### Demographic plots along with the weights
```{r "The demographic plots along with weights"}
d1a
...
```
#### Experimental plot with finer granularity, if i had additional time, I would have explored it further.
```{r "Experimental plot with finer granularity"}
...
```
#### weights for the Demographic factors
```{r}
